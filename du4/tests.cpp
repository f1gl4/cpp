...
TEST_SUITE("Array") {
    ...
    TEST_CASE("Remove item from array") {
        Array array{{new Integer{1}, new Integer{2}, new Integer{3}}};
        array.remove(1);
        REQUIRE(array.size() == 2);
        REQUIRE(dynamic_cast<const Integer*>(array[0])->get_value() == 1);
        REQUIRE(dynamic_cast<const Integer*>(array[1])->get_value() == 3);
    }
...
TEST_SUITE("Object") {
    ...
    TEST_CASE("Remove item from object") {
        Object object{{
                              {"a", new Integer{1}},
                              {"b", new Integer{2}},
                              {"c", new Integer{3}},
        ...
        REQUIRE(dynamic_cast<const Integer*>(object["a"])->get_value() == 1);
        REQUIRE(object["b"] == nullptr);
        REQUIRE(dynamic_cast<const Integer*>(object["c"])->get_value() == 3);
    }
    ...
    TEST_CASE("Remove null") {
        auto* object = new Object{{
            ...
            {"d", new Object{{
                    {"a", new Null{}},
                    {"b", new Array(
                            {new Integer{1}, new Null{}, new Null{}, new Integer{3}, new Integer{2}, new Null{}}
                            )
                    }
                }}
            },
