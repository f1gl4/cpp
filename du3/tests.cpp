...
TEST_CASE("Parse repeat") {
    ...
    auto numbers = "123";
    REQUIRE(parser1(numbers) == numbers + 3);

    auto parser2 = repeat(create_word_parser("abc"), 3);

    REQUIRE_EQ(parser2("abcabc"), nullptr);
    REQUIRE_EQ(parser2("aaaabc"), nullptr);
    REQUIRE_EQ(parser2("aaaaaaaaaaaaaaaa"), nullptr);
    REQUIRE_EQ(parser2("abcabcab"), nullptr);

    auto words = "abcabcabcd";
    REQUIRE_EQ(parser2(words), words + 9);
}
